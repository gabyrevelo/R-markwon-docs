...
__Ejercicio lector__Como $t=`r summary(reg)$coefficients[2,3]`$ es `r tex<-"menor"; if(summary(reg)$coefficients[2,3]>qt(0.975,1,(nrow(data)-2))) tex<-"mayor"; tex` que $t_{`r (nrow(data)-2)`}(\frac{\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
`r tex<-"rechazo"; if(summary(reg)$coefficients[2,3]>qf(0.975,1,(nrow(data)-2))) tex<-"no rechazo"; tex`
$H_0: \beta_2=0$.
